        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h2 class="text-anime">oil <span>change.</span></h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="service-sidebar">
                    ...
                    <!--  Contact Box Start -->
                    <div class="header-contact-box wow
                     fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="header-contact-info">
                            <h3>contact us</h3>
                            <p><a href="#">+2 01150209859</a></p>
                            <p><a href="#">+2 01102489958</a></p>
                        </div>
                    </div>
                    <!--  Contact Box End -->
                    ...
                    <div class="get-started-section wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="get-started-img">
                            <figure>
                                <img src="images/get-started-bg-img.jpg" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="get-started-contact">
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            <a href="{{ url ('/contact')}}" class="btn-default">GET FREE QUOTE</a>
                        </div>
                    </div>
                    <!--  Contact Box End -->
                </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                ...
                <div class="benefit-service-box wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="service-icon">
                        <img src="./images/benefit-service-1.svg" alt="">
                    </div>
                    <!-- service icon end -->
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="benefit-service-box wow fadeInUp" data-wow-delay="0.4s">
                    <!-- service icon start -->
                    <div class="service-icon">
                        <img src="./images/benefit-service-2.svg" alt="">
                    </div>
                    <!-- service icon end -->
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="benefit-service-box wow fadeInUp" data-wow-delay="0.6s">
                    <!-- service icon start -->
                    <div class="service-icon">
                        <img src="./images/benefit-service-3.svg" alt="">
                    </div>
                    <!-- service icon end -->
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="benefit-service-box wow fadeInUp" data-wow-delay="0.8s">
                    <!-- service icon start -->
                    <div class="service-icon">
                        <img src="./images/benefit-service-4.svg" alt="">
                    </div>
                    <!-- service icon end -->
